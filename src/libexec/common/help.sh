...
echo ""
echo "    ${K2HR3CLI_COMMON_OPT_CURLINSECURE_LONG}(${K2HR3CLI_COMMON_OPT_CURLINSECURE_SHORT})"
echo "         Specifies the insecure option when executing the curl"
echo "         command."
echo "         If this option is specified, allows communication to"
echo "         in-secure servers(self-signed certificate)."
echo ""
...
echo "        If the K2HR3 Local Tenant(TENANT) name and this ID value"
echo "        do not match, it will be failure."
echo ""
echo "    ${K2HR3CLI_COMMAND_OPT_DISPLAY_LONG}"
echo "        Specify the display name for the K2HR3 Local Tenant in"
echo "        the K2HR3 Web Application."
echo "        This value can be omitted, and if omitted, the TENANT"
echo "        name is set."
echo ""
echo "    ${K2HR3CLI_COMMAND_OPT_DESCRIPTION_LONG}"
echo "        Specify a description of the K2HR3 Local Tenant."
echo "        This value is optional and defaults to the descriptive"
echo "        text if omitted."
echo ""
echo "    ${K2HR3CLI_COMMAND_OPT_USERS_LONG}"
echo "        Specify the USER names who can use the K2HR3 Local Tenant"
echo "        as an array.(ex, '[\"user1\",\"user2\"]')"
echo "        Only create mode, the USER name indicated by the"
echo "        Unscoped/Scoped User Token sending this request cab be"
echo "        omit."
echo "        It is necessary to specify the USER name registered in"
echo "        the K2HR3 system, and if the USER is not existed, it is"
echo "        ignored. And the USER name can not set as YRN full path."
echo ""
echo "    NOTE:"
