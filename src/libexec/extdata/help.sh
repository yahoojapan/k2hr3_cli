...
#
echo ""
echo "K2HR3 CLI command for the EXTDATA API of the K2HR3 REST API."
echo "    See https://k2hr3.antpick.ax/api_extdata.html"
echo ""
echo "${K2HR3CLI_MODE} is a command that operates on extdata in the K2HR3"
echo "system."
echo ""
echo "GET EXTDATA:"
echo ""
echo "    USAGE: ${BINNAME} ${K2HR3CLI_MODE} <extdata name> <registerpath> <user agent> <option...>"
echo "           ${K2HR3CLI_COMMAND_OPT_OUTPUT_LONG} <file path>"
echo ""
echo "           <extdata name>  Specify the EXTDATA API name set in"
echo "                           the K2HR3 API configuration."
echo "           <registerpath>  Specify the EXTDATA API name set in"
echo "                           the K2HR3 API configuration."
echo "                           this is included in the information"
echo "                           that you can get when you create the"
echo "                           role token. You can also get it by"
echo "                           getting (expanding) the list of role"
echo "                           tokens using scoped tokens."
echo "           <user agent>    Specify the User-Agent which is set"
echo "                           in K2HR3 REST API server"
echo "                           configuration for extdata."
echo ""
echo "OPTION:"
