...
echo ""
echo "    Unscoped Token From OpenID Connect Token:"
echo "        ${BINNAME} ${K2HR3CLI_MODE} create utoken_oidctoken"
...
echo "            ${K2HR3CLI_COMMAND_OPT_TENANT_LONG}(${K2HR3CLI_COMMAND_OPT_TENANT_SHORT}) <tenant>"
echo ""
echo "    Scoped Token From OpenID Connect Token:"
echo "        ${BINNAME} ${K2HR3CLI_MODE} create token_oidctoken"
echo "            ${K2HR3CLI_COMMAND_OPT_OIDC_TOKEN_LONG}(${K2HR3CLI_COMMAND_OPT_OIDC_TOKEN_SHORT}) <OIDC token>"
echo "            ${K2HR3CLI_COMMAND_OPT_TENANT_LONG}(${K2HR3CLI_COMMAND_OPT_TENANT_SHORT}) <tenant>"
echo ""
